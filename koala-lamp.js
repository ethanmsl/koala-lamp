...
function __wbg_adapter_33(arg0, arg1) {
    const ret = wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hee80db97a250622a_multivalue_shim(arg0, arg1);
    if (ret[1]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('koala-lamp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
